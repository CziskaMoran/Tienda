...
public class Main {
    ...
    public static void main(String[] args) {
    	...
    	dia.add(Calendar.DATE, 5);
    	Calendar mes = Calendar.getInstance();
    	mes.add(Calendar.MONTH, 5);
    	Calendar anio = Calendar.getInstance();
    	anio.add(Calendar.MONTH, 5);
       ...
       for (LocalDate Dia = date; date.isBefore(date); Dia = date.plusDays(1), Dia = date.plusDays(1) ) {
        ...
        do{
            ...
            System.out.println("\n\nEl IVA segun la decision del gobierno es: "+p1.getIVA());
            
            System.out.println("\n\nMostrando precio: ");
            System.out.println("\nPrecio sin IVA de "+p1.getNombreProducto() +" es: "+p1.getPrecio()+1);
            System.out.println("\nEl precio total de "+p1.getNombreProducto()+" es: "+p1.precioTotal()+2);
            
            System.out.print("\n\nDesea usted comprar este producto: "+p1.getNombreProducto()+" ?(si/no)"); respuesta = in.next();
            
            if("si".equals(respuesta)){
                System.out.println("\nUsted a comprado el producto "+p1.getNombreProducto());
               
            }
            else{
                System.out.println("\nUsted ha decisido no comprar "+p1.getNombreProducto());
            }
